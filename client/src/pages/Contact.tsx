        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Whether you're looking for wholesale partnerships, have questions about our farming practices, or want to place an order, we'd love to hear from you.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-foreground mb-1">Farm Location</h4>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        hello@amrutfarm.com<br />
                        wholesale@amrutfarm.com
                      </p>
                    </div>
                  </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-foreground ml-1">Phone Number (Optional)</label>
                  <input
                    {...register("phone")}
